   ...
   <div id="main">
          ...
          <div class="row">
              <table class="table col-10 offset-1">
                  ...
                  <tr>
                      <td colspan="2" class="tbbg4">첨부1 : <i class="far fa-file-archive"></i> homework.zip (123KB, 10회 다운로드함)</td>
                  </tr>
                  <tr>
                      <td colspan="2" class="tbbg4">첨부2 : <i class="far fa-file-alt"></i> homework.txt (456KB, 103회 다운로드함)</td>
                  </tr>
                  <tr>
                      <td colspan="2" class="tbbg4">첨부3 : <i class="far fa-file-image"></i> homework.png (789KB, 17회 다운로드함)</td>
                  </tr>
